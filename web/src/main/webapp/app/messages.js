...
var ibMessages = {
    'sv': {
        ...
        'label.table.avslutade.bestallningar.column.faktura': 'Faktura',
        ...
        'server.error.ge.01.title': 'Din ändring kunde inte sparas',
        'server.error.ge.01.text': 'Det har skett förändringar sen du senast laddade sidan som gör att dina ändringar inte kan sparas. Prova att ladda om sidan och försök igen.\n' +
        '\n' +
        'Om problemet kvarstår, kontakta i första hand din lokala IT-avdelning och i andra hand <LINK:ineraNationellKundservice> och uppge då följande logg id: ${logId}',
