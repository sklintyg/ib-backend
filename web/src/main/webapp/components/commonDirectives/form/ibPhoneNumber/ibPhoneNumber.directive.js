 ...
 */
angular.module('ibApp').directive('ibPhoneNumber', [ '$parse', function($parse) {
    'use strict';
    ...
    return {
        ...
        templateUrl: '/components/commonDirectives/form/ibPhoneNumber/ibPhoneNumber.directive.html',
