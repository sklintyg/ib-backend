    ...
    function() {
        ...
        ForfraganFilterModel.prototype.convertToPayload = function() {
            return {
                ...
                inkomDatumFromDate: this.inkomDatum.from,
                inkomDatumToDate: this.inkomDatum.to,

                svarFromDate: this.besvarasSenastDatum.from,
                svarToDate: this.besvarasSenastDatum.to,
