 ...
 */
public class ListAvslutadeBestallningarFilter {

    private List<SelectItem> vardgivare;

    private ListAvslutadeBestallningarFilter() {

    }

    public ListAvslutadeBestallningarFilter(List<SelectItem> vardgivare) {
