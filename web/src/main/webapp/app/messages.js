...
var ibMessages = {
    'sv': {
        ...
        'server.error.acceptinternforfragan.hsa.text': 'Ett tekniskt fel uppstod när vårdenheten skulle hämtas. Om problemet kvarstår, kontakta i första hand din lokala IT-avdelning och i andra hand <LINK:ineraNationellKundservice>',
        'server.error.acceptinternforfragan.myndighet.text': 'Det uppstod ett fel vid anropet till Försäkringskassan. Dina ändringar har inte sparats. Om problemet kvarstår, kontakta i första hand din lokala IT-avdelning och i andra hand <LINK:ineraNationellKundservice>.',
