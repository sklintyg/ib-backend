...
describe('Vårdadmin lista förfrågningar', function() {
    ...
    it('har 3st förfrågningar', function() {
        ...
        getCell(1, 6).should('contain', '2018-07-13');
        ...
        getCell(2, 6).should('contain', '2018-07-13');
...
//        getCell(3, 6).should('contain', '2018-07-13');
