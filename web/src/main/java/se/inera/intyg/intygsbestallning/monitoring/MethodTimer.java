 ...
 */
package se.inera.intyg.intygsbestallning.monitoring;
 ...
 * {@link EnablePrometheusTiming},
 * for methods annotated with {@link PrometheusTimeMethod}.
 *
 * @author Andrew Stuart
 */
@Aspect("pertarget(se.inera.intyg.intygsbestallning.monitoring.MethodTimer.timeable())")
@Scope("prototype")
@ControllerAdvice
public class MethodTimer {
    ...
    @Pointcut("@annotation(se.inera.intyg.intygsbestallning.monitoring.PrometheusTimeMethod)")
