 ...
 */
public interface VacationCalendar extends BusinessCalendar {

    boolean isVacation(LocalDate localDate);

    /**
     * Checks if the specified date is a business day.
     * <p>
     * This is the opposite of {@link #isVacation(LocalDate)}.
