 ...
 */
@Service
public class IbUnitChangeService {

    @Autowired
    private CommonAuthoritiesResolver commonAuthoritiesResolver;

    public boolean changeValdVardenhet(String enhetId, IbUser user) {
    ...
    private boolean hasImplicitAccessToSubUnit(IbUser user, List<String> systemRoleEnhetIdList) {
    ...
    private void updateUsersRoleTo(IbUser user, String roleKey) {
        user.getRoles().clear();
    ...
    private boolean hasSystemRoles(IbUser user) {
